...
namespace graphics {
	...
	void FrustumCulling::CalculateOGLFrustum()
	{
	...
	bool FrustumCulling::PointInFrustum(float x, float y, float z)
	{
	...
	bool FrustumCulling::SphereInFrustum(float x, float y, float z, float radius)
	{
	...
	bool FrustumCulling::CubeInFrustum(float x, float y, float z, float size)
	{
