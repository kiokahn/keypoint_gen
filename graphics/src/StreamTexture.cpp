...
StreamTexture::StreamTexture(int w, int h)
	: width_(w), height_(h),bound_(false)
{
...
void StreamTexture::CopyFromQt(uchar* data)
{
	glTexSubImage2D(GL_TEXTURE_2D, 0, 0, 0, width_, height_, GL_BGRA, GL_UNSIGNED_BYTE, (void*)data);
}
