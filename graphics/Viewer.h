...
public:
	// node view 0, main view 1
	virtual int  viewer_info() { return -1; }
	virtual void draw() {}

	virtual void draw_helper() {}

	virtual void update() {}
	virtual void need_update(bool val) {}
	virtual void mousePressEvent(const graphics::ivec2& p) {}
	virtual void mouseRightButtonPressEvent(const graphics::ivec2& p) {}
