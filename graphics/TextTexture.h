...
namespace graphics
{
	...
	public:
		...
		void SetText(const std::string&, const graphics::vec4& fg_color, const graphics::vec4& bg_color, int text_size, int label_width, int align = 0);
		void SetText(const std::wstring&, const graphics::vec4& fg_color, const graphics::vec4& bg_color, int text_size, int label_width, int align = 0);
